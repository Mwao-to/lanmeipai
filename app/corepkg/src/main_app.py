...
function openDlModal() {
  ...
  box.innerHTML = state.song.img
    ? `<img src="${esc(state.song.img)}" alt="cover" loading="lazy" style="cursor:pointer" title="点击下载封面(.jpg)" onclick="downloadCover()" onerror="this.parentElement.innerHTML='<div class=\'nocover\'>封面加载失败</div>'">`
